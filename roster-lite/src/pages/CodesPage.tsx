...
const CODES: { code: string; dutyType: string; label: string }[] = [
  ...
  { code: 'A1 / A2+ / A3++ / A4… A8', dutyType: 'Standby Home', label: 'Assistência (cabina) — reserva com janela horária' },
  { code: 'H7+ / H9+ / H12+ / H509 / R24…', dutyType: 'Standby Home', label: 'Assistência (pilotos) — reserva com janela horária' },
